const tap                  = require('tap')
    ...
    , AzureLevelDown       = require('./index');

var location = "DefaultEndpointsProtocol=https;AccountName=xxx;AccountKey=yyy"
var x = location;
function factory (location) {
  if (location){
    return new AzureLevelDown(x)  
  } else {
    return new AzureLevelDown()
  }
}
